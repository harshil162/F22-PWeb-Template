            ...
            <div class="tile__intro">
                <div class="intro">
                    ...
                    <div class="intro__section">
                        ...
                        development. </p>
                        <p class="intro_memo">Some programming languages I am familiar with are: MATLAB, Java, Python, JavaScript, and C++. </p>
                        <p class="intro_memo">Tools and technologies I am familiar with are: Onshape, HTML/CSS, Azure Machine Learning, React.js, and Ubuntu. </p>
